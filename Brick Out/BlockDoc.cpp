...
// BlockDoc.cpp : CBlockDoc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CBlockDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CBlockDoc::InitializeSearchContent()
{
...
void CBlockDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
